...
class TestParser(unittest.TestCase):
    ...
    def test_empty(self):
        self.assertDictEqual(
            self.parser.parse_string(""), {"type": "Program", "body": []}
        )
    ...
    def test_empty_statement(self):
        self.assertDictEqual(
            self.parser.parse_string(";"),
            {"type": "Program", "body": [{"type": "EmptyStatement"}]},
        )

    def test_empty_block_statement(self):
        self.assertDictEqual(
            self.parser.parse_string("{}"),
            {"type": "Program", "body": [{"type": "BlockStatement", "body": []}]},
        )
    ...
    def test_binary_multiplicative_expression(self):
        ...
        self.assertIsInstance(
            self.parser.parse_string("1 * 2 / 3 % 4"), dict  # artinya parsing sukses
        )
    ...
    def test_binary_additive_expression(self):
        ...
        self.assertIsInstance(
            self.parser.parse_string("1 + 2 - 3"), dict  # artinya parsing sukses
        )
    ...
    def test_logical_expression(self):
        ...
        self.assertIsInstance(
            self.parser.parse_string("true && true || false"), dict  # parsing sukses
        )
    ...
    def test_assignment_expression(self):
        ...
        self.assertIsInstance(
            self.parser.parse_string("x=x+=x-=x*=x/=x%=x"), dict  # parsing sukses
        )
    ...
    def test_update_expression_noprefix(self):
        ...
        self.assertIsInstance(self.parser.parse_string("x++;x--"), dict)
        ...
        self.assertDictEqual(
            self.parser.parse_string("while (x) {}"),
            {
                ...
                "body": [
                    {
                        "type": "WhileStatement",
                        "condition": {"name": "x", "type": "Identifier"},
    ...
    def test_dowhile_statement_block(self):
        self.assertDictEqual(
            self.parser.parse_string("do {} while (x);"),
            {
                "type": "Program",
                "body": [
                    {
        ...
        self.assertDictEqual(
            self.parser.parse_string("if (true) ;"),
            {
                ...
                "body": [
                    {
                        "type": "IfStatement",
                        "condition": {"type": "Literal", "value": True, "raw": "true"},
    ...
    def test_unary_expression(self):
        ...
        self.assertIsInstance(self.parser.parse_string("+3;-3"), dict)
    ...
    def test_member_expression(self):
        self.assertDictEqual(
            self.parser.parse_string("foo.bar[0]"),
            {
                "type": "Program",
                "body": [
                    {
